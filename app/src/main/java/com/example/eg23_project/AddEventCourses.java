 ...
 * {@link AddEventCourses.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link AddEventCourses#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AddEventCourses extends Fragment implements DatePickerDialog.OnDateSetListener,
     ...
     * @return A new instance of fragment AddEventCourses.
     */
    // TODO: Rename and change types and number of parameters
    public static AddEventCourses newInstance(String param1, String param2) {
        AddEventCourses fragment = new AddEventCourses();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dateTimeFrom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(getActivity(), AddEventCourses.this, year, month, day);
    ...
    */
    ...
    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(getActivity(), AddEventCourses.this, hour, minute, DateFormat.is24HourFormat(getActivity()));
