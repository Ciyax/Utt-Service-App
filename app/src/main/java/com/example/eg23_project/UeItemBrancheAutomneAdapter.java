...
import com.example.eg23_project.UeItemBrancheAutomneFragment.OnListFragmentInteractionListener;
 ...
 */
public class UeItemBrancheAutomneAdapter extends RecyclerView.Adapter<UeItemBrancheAutomneAdapter.ViewHolder> {

    private final List<Ue> mValues;
    private final OnListFragmentInteractionListener mListener;

    public UeItemBrancheAutomneAdapter(List<Ue> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onListFragmentInteractionBrancheAutomne(holder.mItem);
                }
            }
        });
    }
