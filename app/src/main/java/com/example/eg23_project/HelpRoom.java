...
public class HelpRoom extends AppCompatActivity implements RoomListener {

    private String channelID = "zFYdYYPsmwYXWb8o";
    private String roomName = "UTT Help Room";
    private EditText editText;
    private Scaledrone scaledrone;
    private HelpRoomMessageAdapter messageAdapter;
    private ListView messagesView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_help_room);

        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle("Help Room UTT");

        actionBar.setDisplayHomeAsUpEnabled(true);

        editText = (EditText) findViewById(R.id.edit_request);

        messageAdapter = new HelpRoomMessageAdapter(this);
        ...
        scaledrone.connect(new Listener() {
            ...
            public void onOpen() {
                ...
                scaledrone.subscribe(roomName, HelpRoom.this);
            }
    ...
    public void onMessage(Room room, com.scaledrone.lib.Message receivedMessage) {
        ...
        try {
            ...
            final HelpRoomMessage helpRoomMessage = new HelpRoomMessage(
                    receivedMessage.getData().asText(), data, belongsToCurrentUser);
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    messageAdapter.add(helpRoomMessage);
    ...
    private String getRandomName() {
        String[] adjs = {"autumn", "hidden", "bitter", "misty", "silent", "empty", "dry", "dark",
                ...
                "holy", "solitary", "fragrant", "aged", "snowy", "proud", "floral", "restless",
